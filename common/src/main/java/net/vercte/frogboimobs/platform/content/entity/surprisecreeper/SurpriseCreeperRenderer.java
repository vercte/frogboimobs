...
public class SurpriseCreeperRenderer extends MobRenderer<SurpriseCreeper, SurpriseCreeperModel> {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(FrogboiMobs.asResource("surprise_creeper"), "main");
    ...
    @Override
    @NotNull
    public ResourceLocation getTextureLocation(SurpriseCreeper entity) {
        return FrogboiMobs.asResource("textures/entity/surprise_creeper/surprise_creeper.png");
    }
}
